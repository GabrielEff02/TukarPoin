...
class ShoppingCartScreenBackup extends StatefulWidget {
  const ShoppingCartScreenBackup({Key? key, required this.items})
      : super(key: key);

  final List<dynamic> items;

  @override
  _ShoppingCartScreenBackupState createState() =>
      _ShoppingCartScreenBackupState();
}

class _ShoppingCartScreenBackupState extends State<ShoppingCartScreenBackup> {
